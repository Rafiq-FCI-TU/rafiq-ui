...
export default function CareFeature({ number, title, description }: Care) {
  return (
    <section className="flex gap-4 border-l-5 hover:scale-105 transition-all duration-300 border-primary-dark bg-linear-to-r from-gray-100 to-white p-5 rounded-lg">
