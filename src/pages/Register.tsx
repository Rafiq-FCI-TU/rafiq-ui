...
export default function Register() {
  ...
  const handleFamilyPasswordSubmit = (values: any) => {
    ...
    console.log("Received in Register:", values.patientId);
  ...
  const handleAssessmentFormSubmit = (values: any) => {
    ...
    console.log('Complete registration data:', { familyData, childData, specialistData, assessment: values });
    navigate('/dashboard');
  };
    ...
    return (
      <div className="min-h-screen bg-[#DDE4DE] flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div className="flex items-center space-x-3 mb-8">
          <div className="w-11 h-11 bg-white rounded-xl shadow-sm flex items-center justify-center overflow-hidden">
        ...
        {/* Form Container */}
        <div className={`w-full bg-white rounded-3xl shadow-sm overflow-hidden flex ${showAssessmentForm ? 'max-w-200' : 'max-w-125'}`}>
          ...
          <div className={`p-8 md:p-10 ${showAssessmentForm ? 'w-full md:w-1/2' : 'w-full'}`}>
            {/* Family Paths */}
            {showFamilyForm && !showChildForm && !showFamilyPasswordForm && !showAssessmentForm && (
            ...
            {showChildForm && !showFamilyPasswordForm && !showAssessmentForm && (
              <ChildDetailsForm
            ...
            {showFamilyPasswordForm && !showAssessmentForm && (
              <FamilyPasswordForm
            ...
            {/* Specialist Paths */}
            {showSpecialistForm && !showSpecialistPasswordForm && !showAssessmentForm && (
            ...
            {showSpecialistPasswordForm && !showAssessmentForm && (
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 font-sans p-4 lg:p-8">
      <div className="w-full max-w-5xl flex bg-white rounded-4xl shadow-xl overflow-hidden min-h-175">
        {/* Left side: Branding */}
